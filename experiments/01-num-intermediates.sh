...
do
  ...
  ../build/release/benchmark/benchmark_runner "benchmark/imdb/.*" --polr_mode=bushy --threads=1 --log_tuples_routed --nruns=1 --multiplexer_routing=alternate --optimizer_mode="${optimizer_mode}"
  ...
  ## Run TPC-H
  ../build/release/benchmark/benchmark_runner "benchmark/tpch/sf1/.*" --polr_mode=bushy --threads=1 --log_tuples_routed --nruns=1 --multiplexer_routing=alternate --optimizer_mode="${optimizer_mode}"
  ...
  ../build/release/benchmark/benchmark_runner "benchmark/ssb/.*" --polr_mode=bushy --threads=1 --log_tuples_routed --nruns=1 --multiplexer_routing=alternate --optimizer_mode="${optimizer_mode}"
